...
export default function RadioButtonsGroup() {
    ...
    const handleCloseModal = () => {
      // if(connectedCareValue == 'Yes' && deviceIdValue== 'Yes' && handleVerification== 'false') {
      //   alert("As you have opted for consent care & you have your device please enter your valid id and try again to submit your request.");
      //   setDeviceId('');
      // }else{
    ...
    //     alert("Device ID should be exactly 14 digits!");
    //     setDeviceId("");
    //     return false;
    //   } 
    //   else {
    //     alert('Your device ID is stored. We will send the ID to you via email shortly.`');
    //     return true;
    //   }
    // };
